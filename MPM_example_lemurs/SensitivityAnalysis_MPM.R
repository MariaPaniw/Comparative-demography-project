...
# The vital rates are defined as functions, and we need the coefficients from vital rate models (here GLMs). We would appreciate a similar input on your part. Alternatively, it's possible to have GLM models as an object, and then just use the "predict" function, instead of building our own functions. 
