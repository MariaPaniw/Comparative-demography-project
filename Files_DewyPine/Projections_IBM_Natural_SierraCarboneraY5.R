...
outSB_function = function(TSF, seedSurv, seedlingSurv){
  ...
  for(i in 2:n_years){
    ...
    if(nrow(data_droso) > 0){
      ...
      if(length(data_droso$nbFlowers[which(data_droso$flowering == 1)]) > 0){
        ...
        if(any(data_droso_sub$nbFlowers > 0)){
          ...
          if(any(seed_produced$size_unscaled == Inf, na.rm = T)) seed_produced$size_unscaled[which(seed_produced$size_unscaled == Inf)] = max(seed_produced$size_unscaled[which(seed_produced$size_unscaled != Inf)], na.rm = T)
          
          seed_produced$size_unscaled[which(seed_produced$size_unscaled < 0)] = 0
      ...
      if(any(data_droso$sizeNext == Inf, na.rm = T)) data_droso$sizeNext[which(data_droso$sizeNext == Inf)] = max(data_droso$sizeNext[which(data_droso$sizeNext != Inf)], na.rm = T)
      
      data_droso$sizeNext[which(data_droso$sizeNext < 0)] = 0
    ...
    if(nrow(data_SB) > 0){
      ...
      if(length(which(data_SB$outSB == 1)) > 0){
        ...
        data_SB$size_unscaled[which(data_SB$size_unscaled < 0)] = 0
        
        if(any(data_SB$size_unscaled == Inf, na.rm = T)) data_SB$size_unscaled[which(data_SB$size_unscaled == Inf)] = max(data_SB$size_unscaled[which(data_SB$size_unscaled != Inf)], na.rm = T)
...
ibm_natural = function(n_sim = 1000,               # Number of simulations
  ...
  for(sim in 1:n_sim){
    ...
    # ibm_sim_result = ibm_sim(n_sim = n_sim,
    #                          n_years = n_years,
    #                          sim = sim,
...
recruitCap$TSFcont_unscaled[which(recruitCap$TSFcont_unscaled > 4)] = 4

recruitCap = aggregate(ID ~ TSFcont_unscaled,
                       data = recruitCap, FUN = max)

recruitCap$ID = round(recruitCap$ID)

max_nbFlowers = aggregate(fs * fps ~ time + TSFcont_unscaled,
                          data = droso[which(droso$site == population), ], FUN = max)

max_nbFlowers = round(max(max_nbFlowers$`fs * fps`))
...
save(ibm_sierracarboneray5_summerT_min_other_cov_mean, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_summerT_max_other_cov_mean, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_summerT_min_other_cov_obs, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_summerT_max_other_cov_obs, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_prevwinterT_min_other_cov_mean, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_prevwinterT_max_other_cov_mean, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_prevwinterT_min_other_cov_obs, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_prevwinterT_max_other_cov_obs, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_fallR_min_other_cov_mean, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_fallR_max_other_cov_mean, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_fallR_min_other_cov_obs, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_fallR_max_other_cov_obs, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_prevfallR_min_other_cov_mean, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_prevfallR_max_other_cov_mean, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_prevfallR_min_other_cov_obs, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_prevfallR_max_other_cov_obs, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_dens_min_other_cov_mean, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_dens_max_other_cov_mean, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_dens_min_other_cov_obs, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_dens_max_other_cov_obs, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_size_min_other_cov_mean, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_size_max_other_cov_mean, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_size_min_other_cov_obs, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_size_max_other_cov_obs, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_TSF_min_other_cov_mean, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_TSF_max_other_cov_mean, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_TSF_min_other_cov_obs, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()
...
save(ibm_sierracarboneray5_TSF_max_other_cov_obs, file = paste0("Output/IBM_Natural_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()