...
This is the code for sensitivity analyses conducted on the Common linnet (*Linaria cannabina*) which is species 8 of this study: https://doi.org/10.1098/rstb.2022.0194
...
# SPECIES 8 parameters
post_sample_list=readRDS("Post_sample_list.rds")
# Juvenile survival
jSv0.sp8=post_sample_list$`Common linnet`$juvSurv
jS.pr1.sp8=post_sample_list$`Common linnet`$jSb.pr1
jS.pr2.sp8=post_sample_list$`Common linnet`$jSb.pr2
jS.tm1.sp8=post_sample_list$`Common linnet`$jSb.tm1
jS.tm2.sp8=post_sample_list$`Common linnet`$jSb.tm2

# Fecundity
Fec0.sp8=post_sample_list$`Common linnet`$Fecund
Fc.pr1.sp8=post_sample_list$`Common linnet`$Fcb.pr1
Fc.pr2.sp8=post_sample_list$`Common linnet`$Fcb.pr2
Fc.tm1.sp8=post_sample_list$`Common linnet`$Fcb.tm1
Fc.tm2.sp8=post_sample_list$`Common linnet`$Fcb.tm2
DDp.sp8=post_sample_list$`Common linnet`$DensDep

# Adult survival
aSv0.sp8=post_sample_list$`Common linnet`$adSurv
aS.pr1.sp8=post_sample_list$`Common linnet`$aSb.pr1
aS.pr2.sp8=post_sample_list$`Common linnet`$aSb.pr2
aS.tm1.sp8=post_sample_list$`Common linnet`$aSb.tm
```
...
```{r}
cov=read.csv("LinariaCovariates.csv")
...
for(u in 1:100){
  mpm <- matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=mean.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=mean.Tbr,Pbr=mean.Pbr),
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=mean.Twn,Pwn=mean.Pwn)),2,2)
...
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=mean.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=max.Tbr,Pbr=mean.Pbr), 
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=mean.Twn,Pwn=mean.Pwn)),2,2)
# matrix with min Tbr values
mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=mean.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=min.Tbr,Pbr=mean.Pbr), 
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=mean.Twn,Pwn=mean.Pwn)),2,2)
...
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=Tat_when_Tbr_max,Pwn=Pwn_when_Tbr_max),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=max.Tbr,Pbr=Pbr_when_Tbr_max),
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=Twn_when_Tbr_max,Pwn=Pwn_when_Tbr_max)),2,2)
# matrix with min values
mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=Tat_when_Tbr_min,Pwn=Pwn_when_Tbr_min),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=min.Tbr,Pbr=Pbr_when_Tbr_min),
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=Twn_when_Tbr_min,Pwn=Pwn_when_Tbr_min)),2,2)
...
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=mean.Tat,Pwn=max.Pwn),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=mean.Tbr,Pbr=mean.Pbr), 
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=mean.Twn,Pwn=max.Pwn)),2,2)

mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=mean.Tat,Pwn=min.Pwn),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=mean.Tbr,Pbr=mean.Pbr), 
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=mean.Twn,Pwn=min.Pwn)),2,2)

delta.Pwn[u]=abs((lambda(mpm.max)-lambda(mpm.min))/((max.Pwn-min.Pwn)/sd.Pwn))

# 2. Sensitivity to Pwn assuming covariation
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=Tat_when_Pwn_max,Pwn=max.Pwn),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=Tbr_when_Pwn_max,Pbr=Pbr_when_Pwn_max), 
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=Twn_when_Pwn_max,Pwn=max.Pwn)),2,2)

mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=Tat_when_Pwn_min,Pwn=min.Pwn),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=Tbr_when_Pwn_min,Pbr=Pbr_when_Pwn_min), 
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=Twn_when_Pwn_min,Pwn=min.Pwn)),2,2)
...
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=mean.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=mean.Tbr,Pbr=max.Pbr), 
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=mean.Twn,Pwn=mean.Pwn)),2,2)

mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=mean.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=mean.Tbr,Pbr=min.Pbr), 
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=mean.Twn,Pwn=mean.Pwn)),2,2)
...
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=Tat_when_Pbr_max,Pwn=Pwn_when_Pbr_max),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=Tbr_when_Pbr_max,Pbr=max.Pbr),
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=Twn_when_Pbr_max,Pwn=Pwn_when_Pbr_max)),2,2)

mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=Tat_when_Pbr_min,Pwn=Pwn_when_Pbr_min),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=Tbr_when_Pbr_min,Pbr=min.Pbr),
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=Twn_when_Pbr_min,Pwn=Pwn_when_Pbr_min)),2,2)
...
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=mean.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=mean.Tbr,Pbr=mean.Pbr), 
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=max.Twn,Pwn=mean.Pwn)),2,2)

mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=mean.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=mean.Tbr,Pbr=mean.Pbr), 
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=min.Twn,Pwn=mean.Pwn)),2,2)

delta.Twn[u]=abs((lambda(mpm.max)-lambda(mpm.min))/((max.Twn-min.Twn)/sd.Twn))

# 2. Sensitivity to Twn assuming covariation
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=Tat_when_Twn_max,Pwn=Pwn_when_Twn_max),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=Tbr_when_Twn_max,Pbr=Pbr_when_Twn_max), 
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=max.Twn,Pwn=Pwn_when_Twn_max)),2,2)

mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=Tat_when_Twn_min,Pwn=Pwn_when_Twn_min),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=Tbr_when_Twn_min,Pbr=Pbr_when_Twn_min), 
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=min.Twn,Pwn=Pwn_when_Twn_min)),2,2)
...
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=max.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=mean.Tbr,Pbr=mean.Pbr), 
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=mean.Twn,Pwn=mean.Pwn)),2,2)

mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=min.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=mean.Tbr,Pbr=mean.Pbr), 
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=mean.Twn,Pwn=mean.Pwn)),2,2)
...
# 2. Sensitivity to Twn assuming covariation
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=max.Tat,Pwn=Pwn_when_Tat_max),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=Tbr_when_Tat_max,Pbr=Pbr_when_Tat_max), 
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=Twn_when_Tat_max,Pwn=Pwn_when_Tat_max)),2,2)

mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=min.Tat,Pwn=Pwn_when_Tat_min),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=Tbr_when_Tat_min,Pbr=Pbr_when_Tat_min), 
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=Twn_when_Tat_min,Pwn=Pwn_when_Tat_min)),2,2)
...
mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=Tat_when_Pwn_min,Pwn=min.Pwn),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=mean.Tbr,mean.Pbr),
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=mean.Twn,Pwn=mean.Pwn)),2,2)
...
mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp8[u],jS.pr1.sp8[u],jS.pr2.sp8[u],jS.tm1.sp8[u],jS.tm2.sp8[u],Tat=mean.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp8[u],Fc.pr1.sp8[u],Fc.pr2.sp8[u],Fc.tm1.sp8[u],Fc.tm2.sp8[u],DDp.sp8[u],Tbr=mean.Tbr,Pbr=min.Pbr),
                DER_adSurv(aSv0.sp8[u],aS.pr1.sp8[u],aS.pr2.sp8[u],aS.tm1.sp8[u],Twn=mean.Twn,Pwn=mean.Twn)),2,2)
...
write.csv(ScaledSens,"Output/Linaria_Sens.csv",row.names = F)
...
write.csv(ScaledSensVR,"Output/Linaria_Sens_per_VR.csv",row.names = F)
```
