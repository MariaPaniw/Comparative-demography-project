...
This is the code for sensitivity analyses conducted on the Bullfinch (*Pyrrhula pyrrhula*) which is species 2 of this study: https://doi.org/10.1098/rstb.2022.0194
...
## a) Fecundity
loc_dens <- 1
DER_Fecund <- function(Fec0, Fc.pr1, Fc.pr2, Fc.tm1, Fc.tm2, DDp, Tbr, Pbr, Hab=80){ 
	exp(
		log(Fec0) + 
		Fc.pr1*Pbr + 
		Fc.pr2*Pbr^2 + 
...
## b) Juvenile survival
DER_juvSurv <- function(jSv0, jS.pr1, jS.pr2, jS.tm1, jS.tm2, Tat, Pwn){
	plogis(
		jS.pr1*Pwn + 
		jS.pr2*Pwn^2 + 
		jS.tm1*Tat + 
...
## c) Adult survival
DER_adSurv <- function(aSv0, aS.pr1, aS.pr2, aS.tm1, Twn, Pwn){
	plogis(
		aS.pr1*Pwn + 
		aS.pr2*Pwn^2 + 
		aS.tm1*Twn ,
...
# Juvenile survival
jSv0.sp2=post_sample_list$`Bullfinch`$juvSurv
jS.pr1.sp2=post_sample_list$`Bullfinch`$jSb.pr1
jS.pr2.sp2=post_sample_list$`Bullfinch`$jSb.pr2
jS.tm1.sp2=post_sample_list$`Bullfinch`$jSb.tm1
jS.tm2.sp2=post_sample_list$`Bullfinch`$jSb.tm2

# Fecundity
Fec0.sp2=post_sample_list$`Bullfinch`$Fecund
Fc.pr1.sp2=post_sample_list$`Bullfinch`$Fcb.pr1
Fc.pr2.sp2=post_sample_list$`Bullfinch`$Fcb.pr2
Fc.tm1.sp2=post_sample_list$`Bullfinch`$Fcb.tm1
Fc.tm2.sp2=post_sample_list$`Bullfinch`$Fcb.tm2
DDp.sp2=post_sample_list$`Bullfinch`$DensDep

# Adult survival
aSv0.sp2=post_sample_list$`Bullfinch`$adSurv
aS.pr1.sp2=post_sample_list$`Bullfinch`$aSb.pr1
aS.pr2.sp2=post_sample_list$`Bullfinch`$aSb.pr2
aS.tm1.sp2=post_sample_list$`Bullfinch`$aSb.tm
```
...
```{r}
cov=read.csv("PyrrhulaCovariates.csv")
...
for(u in 1:100){
  mpm <- matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=mean.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=mean.Tbr,Pbr=mean.Pbr),
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=mean.Twn,Pwn=mean.Pwn)),2,2)
...
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=mean.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=max.Tbr,Pbr=mean.Pbr), 
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=mean.Twn,Pwn=mean.Pwn)),2,2)
# matrix with min Tbr values
mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=mean.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=min.Tbr,Pbr=mean.Pbr), 
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=mean.Twn,Pwn=mean.Pwn)),2,2)
...
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=Tat_when_Tbr_max,Pwn=Pwn_when_Tbr_max),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=max.Tbr,Pbr=Pbr_when_Tbr_max),
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=Twn_when_Tbr_max,Pwn=Pwn_when_Tbr_max)),2,2)
# matrix with min values
mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=Tat_when_Tbr_min,Pwn=Pwn_when_Tbr_min),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=min.Tbr,Pbr=Pbr_when_Tbr_min),
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=Twn_when_Tbr_min,Pwn=Pwn_when_Tbr_min)),2,2)
...
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=mean.Tat,Pwn=max.Pwn),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=mean.Tbr,Pbr=mean.Pbr), 
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=mean.Twn,Pwn=max.Pwn)),2,2)

mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=mean.Tat,Pwn=min.Pwn),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=mean.Tbr,Pbr=mean.Pbr), 
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=mean.Twn,Pwn=min.Pwn)),2,2)
...
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=Tat_when_Pwn_max,Pwn=max.Pwn),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=Tbr_when_Pwn_max,Pbr=Pbr_when_Pwn_max), 
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=Twn_when_Pwn_max,Pwn=max.Pwn)),2,2)

mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=Tat_when_Pwn_min,Pwn=min.Pwn),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=Tbr_when_Pwn_min,Pbr=Pbr_when_Pwn_min), 
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=Twn_when_Pwn_min,Pwn=min.Pwn)),2,2)
...
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=mean.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=mean.Tbr,Pbr=max.Pbr), 
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=mean.Twn,Pwn=mean.Pwn)),2,2)

mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=mean.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=mean.Tbr,Pbr=min.Pbr), 
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=mean.Twn,Pwn=mean.Pwn)),2,2)
...
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=Tat_when_Pbr_max,Pwn=Pwn_when_Pbr_max),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=Tbr_when_Pbr_max,Pbr=max.Pbr),
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=Twn_when_Pbr_max,Pwn=Pwn_when_Pbr_max)),2,2)

mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=Tat_when_Pbr_min,Pwn=Pwn_when_Pbr_min),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=Tbr_when_Pbr_min,Pbr=min.Pbr),
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=Twn_when_Pbr_min,Pwn=Pwn_when_Pbr_min)),2,2)
...
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=mean.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=mean.Tbr,Pbr=mean.Pbr), 
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=max.Twn,Pwn=mean.Pwn)),2,2)

mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=mean.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=mean.Tbr,Pbr=mean.Pbr), 
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=min.Twn,Pwn=mean.Pwn)),2,2)
...
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=Tat_when_Twn_max,Pwn=Pwn_when_Twn_max),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=Tbr_when_Twn_max,Pbr=Pbr_when_Twn_max), 
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=max.Twn,Pwn=Pwn_when_Twn_max)),2,2)

mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=Tat_when_Twn_min,Pwn=Pwn_when_Twn_min),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=Tbr_when_Twn_min,Pbr=Pbr_when_Twn_min), 
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=min.Twn,Pwn=Pwn_when_Twn_min)),2,2)
...
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=max.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=mean.Tbr,Pbr=mean.Pbr), 
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=mean.Twn,Pwn=mean.Pwn)),2,2)

mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=min.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=mean.Tbr,Pbr=mean.Pbr), 
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=mean.Twn,Pwn=mean.Pwn)),2,2)
...
# 2. Sensitivity to Twn assuming covariation
mpm.max=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=max.Tat,Pwn=Pwn_when_Tat_max),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=Tbr_when_Tat_max,Pbr=Pbr_when_Tat_max), 
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=Twn_when_Tat_max,Pwn=Pwn_when_Tat_max)),2,2)

mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=min.Tat,Pwn=Pwn_when_Tat_min),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=Tbr_when_Tat_min,Pbr=Pbr_when_Tat_min), 
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=Twn_when_Tat_min,Pwn=Pwn_when_Tat_min)),2,2)
...
mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=Tat_when_Pwn_min,Pwn=min.Pwn),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=mean.Tbr,mean.Pbr),
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=mean.Twn,Pwn=mean.Pwn)),2,2)
...
mpm.min=matrix(c(0,DER_juvSurv(jSv0.sp2[u],jS.pr1.sp2[u],jS.pr2.sp2[u],jS.tm1.sp2[u],jS.tm2.sp2[u],Tat=mean.Tat,Pwn=mean.Pwn),
                DER_Fecund(Fec0.sp2[u],Fc.pr1.sp2[u],Fc.pr2.sp2[u],Fc.tm1.sp2[u],Fc.tm2.sp2[u],DDp.sp2[u],Tbr=mean.Tbr,Pbr=min.Pbr),
                DER_adSurv(aSv0.sp2[u],aS.pr1.sp2[u],aS.pr2.sp2[u],aS.tm1.sp2[u],Twn=mean.Twn,Pwn=mean.Twn)),2,2)
...
write.csv(ScaledSens,"output/Pyrrhula_Sens.csv",row.names = F)
...
write.csv(ScaledSensVR,"output/Pyrrhula_Sens_per_VR.csv",row.names = F,
		  mat=1, # age at first repro
                	  n.vr=3, # number of vital rates with covariates
                      n.pam=15, # number of parameters
                	  dens=0, # density dependence in it?
...
write.csv(sensvr,"output/Pyrrhula_Sens_per_VR.csv",row.names = F)
```
