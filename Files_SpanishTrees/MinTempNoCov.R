...
# The covariates are set to: minimum temperature and everything else to mean values across the study period
...
# put the results of each simulation run into a separate folder in the results folder "MinTempNoCov"
# example: run 5

for (i in 1:16) {
  write.csv(results[[i]], paste0("MinTempNoCov/run5/results.sp", i, ".csv"),row.names = F)
}
