...
non_repro_survival_function = function(size, abLarge, fallR, summerT, year, population){
...
repro_survival_function = function(size, abLarge, fallR, summerT, year, population){
...
sd_prevwinterR    = sd(prevwinterR_timeSeries$prevwinterR_unscaled[which(prevwinterR_timeSeries$site == population)], na.rm = T)
...
## 4.2.7. Min previous winter cumulative rainfall ----
# -----------------------------------------------
...
# Size
size_value_min_prevwinterR = mean(droso_pop$size_unscaled[which(droso_pop$time == year_min_prevwinterR)])


## 4.2.8. Max previous winter cumulative rainfall ----
# -----------------------------------------------
...
# Size
size_value_max_prevwinterR = mean(droso_pop$size_unscaled[which(droso_pop$time == year_max_prevwinterR)])
...
ibm_sim = function(n_sim,              # Number of simulations
  ...
  if(focal_vr == "non_repro_survival"){
    ...
    rSurv_summerT_value = growth_summerT_value = unique(covariates_values$other_value[which(covariates_values$other_cov == "summerT" &
    ...
    seedlingSize_prevwinterT_value = unique(covariates_values$other_value[which(covariates_values$other_cov == "prevwinterT" &
                                                                                  covariates_values$other_mean_obs == "mean")])
    
    nbFlowers_prevfallR_value = unique(covariates_values$other_value[which(covariates_values$other_cov == "prevfallR" &
                                                                             covariates_values$other_mean_obs == "mean")])
    
    flowering_prevwinterR_value = unique(covariates_values$other_value[which(covariates_values$other_cov == "prevwinterR" &
                                                                               covariates_values$other_mean_obs == "mean")])
    ...
    rSurv_dens_value = growth_dens_value = flowering_dens_value = nbFlowers_dens_value = seedlingSize_dens_value = unique(covariates_values$other_value[which(covariates_values$other_cov == "dens" &
                                                                                                                                                                covariates_values$other_mean_obs == "mean")])
  ...
  if(focal_vr == "repro_survival"){
    ...
    nrSurv_summerT_value = growth_summerT_value = unique(covariates_values$other_value[which(covariates_values$other_cov == "summerT" &
                                                                                               covariates_values$other_mean_obs == "mean")])
    ...
    nrSurv_dens_value = growth_dens_value = flowering_dens_value = nbFlowers_dens_value = seedlingSize_dens_value = unique(covariates_values$other_value[which(covariates_values$other_cov == "dens" &
                                                                                                                                                                 covariates_values$other_mean_obs == "mean")])
  ...
  if(focal_vr == "flowering"){
    ...
    if(focal_cov == "prevwinterR"){
      
      # Temperature value
      flowering_prevwinterR_value = unique(covariates_values$focal_value[which(covariates_values$focal_cov == focal_cov &
                                                                                 covariates_values$focal_min_max == focal_min_max)])
    ...
    # Focal covariate = Aboveground density of large individuals
      ...
      flowering_prevwinterR_value = unique(covariates_values$other_value[which(covariates_values$other_cov == "prevwinterT" &
                                                                                 covariates_values$other_mean_obs == "obs" &
                                                                                 covariates_values$focal_cov == focal_cov &
                                                                                 covariates_values$focal_min_max == focal_min_max)])
    ...
    nrSurv_summerT_value = rSurv_summerT_value = growth_summerT_value = unique(covariates_values$other_value[which(covariates_values$other_cov == "summerT" &
                                                                                                                     covariates_values$other_mean_obs == "mean")])
    
    nrSurv_fallR_value = rSurv_fallR_value = unique(covariates_values$other_value[which(covariates_values$other_cov == "fallR" &
                                                                                          covariates_values$other_mean_obs == "mean")])
    ...
    nrSurv_size_value = rSurv_size_value = growth_size_value = nbFlowers_size_value = unique(covariates_values$other_value[which(covariates_values$other_cov == "size" &
                                                                                                                                   covariates_values$other_mean_obs == "mean")])
    
    nrSurv_dens_value = rSurv_dens_value = growth_dens_value = nbFlowers_dens_value = seedlingSize_dens_value = unique(covariates_values$other_value[which(covariates_values$other_cov == "dens" &
                                                                                                                                                             covariates_values$other_mean_obs == "mean")])
    ...
    if(nrow(data_droso) > 0){
      ...
      data_droso$flowering = rbinom(n = nrow(data_droso), 
                                    flowering_function(size = flowering_size_value,
                                                       ...
                                                       prevwinterR = flowering_prevwinterR_value,
                                                       year = year_obs,
      ...
      if(length(data_droso$nbFlowers[which(data_droso$flowering == 1)]) > 0){
        ...
        data_droso$nbFlowers[which(data_droso$flowering == 1)] = rnbinom(n = nrow(data_droso[which(data_droso$flowering == 1), ]),
                                                                         mu = nbFlowers_function(size = nbFlowers_size_value,
                                                                                                 prevfallR = nbFlowers_prevfallR_value,
                                                                                                 year = year_obs,
                                                                                                 population = population),
                                                                         size = 1)
...
ibm_monteratorero_nrSurv_summerT_min <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_monteratorero_nrSurv_summerT_min, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_monteratorero_nrSurv_summerT_max <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_monteratorero_nrSurv_summerT_max, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_monteratorero_nrSurv_fallR_min <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_monteratorero_nrSurv_fallR_min, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_monteratorero_nrSurv_fallR_max <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_monteratorero_nrSurv_fallR_max, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_monteratorero_nrSurv_dens_min <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_monteratorero_nrSurv_dens_min, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_monteratorero_nrSurv_dens_max <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_monteratorero_nrSurv_dens_max, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_monteratorero_rSurv_summerT_min <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_monteratorero_rSurv_summerT_min, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_monteratorero_rSurv_summerT_max <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_monteratorero_rSurv_summerT_max, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_monteratorero_rSurv_fallR_min <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_monteratorero_rSurv_fallR_min, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_monteratorero_rSurv_fallR_max <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_monteratorero_rSurv_fallR_max, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_monteratorero_rSurv_dens_min <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_monteratorero_rSurv_dens_min, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_monteratorero_rSurv_dens_max <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_monteratorero_rSurv_dens_max, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()


## 6.1.13. Focal vital rate = flowering probability, focal covariate = prevwinterR, focal value = min ----
# ---------------------------------------------------------------------------------------------------
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_monteratorero_flowering_prevwinterR_min <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_monteratorero_flowering_prevwinterR_min, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()


## 6.1.14. Focal vital rate = flowering probability, focal covariate = prevwinterR, focal value = max ----
# ---------------------------------------------------------------------------------------------------
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_monteratorero_flowering_prevwinterR_max <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_monteratorero_flowering_prevwinterR_max, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_monteratorero_flowering_dens_min <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_monteratorero_flowering_dens_min, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_monteratorero_flowering_dens_max <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_monteratorero_flowering_dens_max, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()