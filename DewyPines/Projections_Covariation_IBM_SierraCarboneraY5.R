...
# Dewy-pine data
droso = read.csv("../02_VitalRate_Models/droso_natural.csv")
droso_full = read.csv("../00_Data/dataDroso2022.csv")
droso_full$quadratID = paste(droso_full$transect, droso_full$subQuadrat, sep = "_")

droso_seedbank = read.csv("../02_VitalRate_Models/DisturbedPopulations/Output/droso_SeedBank_NoDormancyLoss.csv")
...
# TSF
TSF_value_min_summerT = mean(droso$TSFcont_unscaled[which(droso$time == year_min_summerT)])
...
# TSF
TSF_value_max_summerT = mean(droso$TSFcont_unscaled[which(droso$time == year_max_summerT)])
...
# TSF
TSF_value_min_prevwinterT = mean(droso$TSFcont_unscaled[which(droso$time == year_min_prevwinterT)])
...
# TSF
TSF_value_max_prevwinterT = mean(droso$TSFcont_unscaled[which(droso$time == year_max_prevwinterT)])
...
# TSF
TSF_value_min_fallR = mean(droso$TSFcont_unscaled[which(droso$time == year_min_fallR)])
...
# TSF
TSF_value_max_fallR = mean(droso$TSFcont_unscaled[which(droso$time == year_max_fallR)])
...
# TSF
TSF_value_min_prevfallR = mean(droso$TSFcont_unscaled[which(droso$time == year_min_prevfallR)])
...
# TSF
TSF_value_max_prevfallR = mean(droso$TSFcont_unscaled[which(droso$time == year_max_prevfallR)])
...
# TSF
TSF_value_min_dens = mean(droso$TSFcont_unscaled[which(droso$time == year_min_dens)])
...
# TSF
TSF_value_max_dens = mean(droso$TSFcont_unscaled[which(droso$time == year_max_dens)])
...
# TSF
TSF_value_min_size = mean(droso$TSFcont_unscaled[which(droso$time == year_min_size)])
...
# TSF
TSF_value_max_size = mean(droso$TSFcont_unscaled[which(droso$time == year_max_size)])
...
# Size
size_value_min_TSF = mean(droso$size_unscaled[which(droso$time == year_min_TSF)])
...
# Size
size_value_max_TSF = mean(droso$size_unscaled[which(droso$time == year_max_TSF)])
...
recruitCap = rbind(recruitCap, 
                   data.frame(TSFcont = 0,
                              ID = c(round(max(recruitCap$ID) * 1.5))))
...
ibm_sierracarboneray5_summerT_min_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_summerT_min_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_summerT_min_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_summerT_max_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_summerT_max_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_summerT_max_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_summerT_min_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_summerT_min_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_summerT_min_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_summerT_max_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_summerT_max_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_summerT_max_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_prevwinterT_min_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_prevwinterT_min_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_prevwinterT_min_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_prevwinterT_max_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_prevwinterT_max_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_prevwinterT_max_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_prevwinterT_min_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_prevwinterT_min_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_prevwinterT_min_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_prevwinterT_max_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_prevwinterT_max_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_prevwinterT_max_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_fallR_min_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_fallR_min_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_fallR_min_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_fallR_max_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_fallR_max_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_fallR_max_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_fallR_min_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_fallR_min_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_fallR_min_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_fallR_max_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_fallR_max_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_fallR_max_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_prevfallR_min_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_prevfallR_min_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_prevfallR_min_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_prevfallR_max_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_prevfallR_max_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_prevfallR_max_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_prevfallR_min_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_prevfallR_min_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_prevfallR_min_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_prevfallR_max_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_prevfallR_max_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_prevfallR_max_other_cov_obs)


## 5.1.17. Focal covariate = dens, focal value = min, other covariates = mean ----
# -------------------------------------------------------------------------------
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_dens_min_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_dens_min_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_dens_min_other_cov_mean)


## 5.1.18. Focal covariate = dens, focal value = max, other covariates = mean ----
# -------------------------------------------------------------------------------
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_dens_max_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_dens_max_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_dens_max_other_cov_mean)


## 5.1.19. Focal covariate = dens, focal value = min, other covariates = obs ----
# -------------------------------------------------------------------------------
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_dens_min_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_dens_min_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_dens_min_other_cov_obs)


## 5.1.20. Focal covariate = dens, focal value = max, other covariates = obs ----
# -------------------------------------------------------------------------------
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_dens_max_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_dens_max_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_dens_max_other_cov_obs)


## 5.1.21. Focal covariate = size, focal value = min, other covariates = mean ----
# -------------------------------------------------------------------------------
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_size_min_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_size_min_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_size_min_other_cov_mean)


## 5.1.22. Focal covariate = size, focal value = max, other covariates = mean ----
# -------------------------------------------------------------------------------
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_size_max_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_size_max_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_size_max_other_cov_mean)


## 5.1.23. Focal covariate = size, focal value = min, other covariates = obs ----
# -------------------------------------------------------------------------------
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_size_min_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_size_min_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_size_min_other_cov_obs)


## 5.1.24. Focal covariate = size, focal value = max, other covariates = obs ----
# -------------------------------------------------------------------------------
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_size_max_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_size_max_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_size_max_other_cov_obs)


## 5.1.25. Focal covariate = TSF, focal value = min, other covariates = mean ----
# -------------------------------------------------------------------------------
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_TSF_min_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_TSF_min_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_TSF_min_other_cov_mean)


## 5.1.26. Focal covariate = TSF, focal value = max, other covariates = mean ----
# -------------------------------------------------------------------------------
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_TSF_max_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_TSF_max_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_TSF_max_other_cov_mean)


## 5.1.27. Focal covariate = TSF, focal value = min, other covariates = obs ----
# -------------------------------------------------------------------------------
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_TSF_min_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_TSF_min_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_TSF_min_other_cov_obs)


## 5.1.28. Focal covariate = TSF, focal value = max, other covariates = obs ----
# -------------------------------------------------------------------------------
...
# Results of each set of iterations are saved to a file
ibm_sierracarboneray5_TSF_max_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierracarboneray5_TSF_max_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_sierracarboneray5_TSF_max_other_cov_obs)