...
# setwd
setwd("/Users/esinickin/Desktop/Comparative-demography-project-main/DewyPines")
...
V.fallR_l_ratio <- abs(log(fallR.no.cov$lambda_max/fallR.no.cov$lambda_min))
hist(V.fallR_l_ratio)
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
V.fallR.cov_l_ratio <- abs(log(fallR.cov$lambda_max/fallR.cov$lambda_min))
hist(V.fallR.cov_l_ratio)
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
V.prevfallR_l_ratio <- abs(log(prevfallR.no.cov$lambda_max/prevfallR.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
V.prevfallR.cov_l_ratio <- abs(log(prevfallR.cov$lambda_max/prevfallR.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
V.prevwinterT_l_ratio <- abs(log(prevwinterT.no.cov$lambda_max/prevwinterT.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
V.prevwinterT.cov_l_ratio <- abs(log(prevwinterT.cov$lambda_max/prevwinterT.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
V.summerT_l_ratio <- abs(log(summerT.no.cov$lambda_max/summerT.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
V.summerT.cov_l_ratio <- abs(log(summerT.cov$lambda_max/summerT.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
V.dens_l_ratio <- abs(log(dens.no.cov$lambda_max/dens.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
V.dens.cov_l_ratio <- abs(log(dens.cov$lambda_max/dens.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SC.fallR_l_ratio <- abs(log(fallR.no.cov$lambda_max/fallR.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SC.fallR.cov_l_ratio <- abs(log(fallR.cov$lambda_max/fallR.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SC.prevfallR_l_ratio <- abs(log(prevfallR.no.cov$lambda_max/prevfallR.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SC.prevfallR.cov_l_ratio <- abs(log(prevfallR.cov$lambda_max/prevfallR.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SC.prevwinterT_l_ratio <- abs(log(prevwinterT.no.cov$lambda_max/prevwinterT.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SC.prevwinterT.cov_l_ratio <- abs(log(prevwinterT.cov$lambda_max/prevwinterT.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SC.summerT_l_ratio <- abs(log(summerT.no.cov$lambda_max/summerT.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SC.summerT.cov_l_ratio <- abs(log(summerT.cov$lambda_max/summerT.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SC.dens_l_ratio <- abs(log(dens.no.cov$lambda_max/dens.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SC.dens.cov_l_ratio <- abs(log(dens.cov$lambda_max/dens.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SR.fallR_l_ratio <- abs(log(fallR.no.cov$lambda_max/fallR.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SR.fallR.cov_l_ratio <- abs(log(fallR.cov$lambda_max/fallR.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SR.prevfallR_l_ratio <- abs(log(prevfallR.no.cov$lambda_max/prevfallR.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SR.prevfallR.cov_l_ratio <- abs(log(prevfallR.cov$lambda_max/prevfallR.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SR.prevwinterT_l_ratio <- abs(log(prevwinterT.no.cov$lambda_max/prevwinterT.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SR.prevwinterT.cov_l_ratio <- abs(log(prevwinterT.cov$lambda_max/prevwinterT.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SR.summerT_l_ratio <- abs(log(summerT.no.cov$lambda_max/summerT.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SR.summerT.cov_l_ratio <- abs(log(summerT.cov$lambda_max/summerT.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SR.dens_l_ratio <- abs(log(dens.no.cov$lambda_max/dens.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SR.dens.cov_l_ratio <- abs(log(dens.cov$lambda_max/dens.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
B.fallR_l_ratio <- abs(log(fallR.no.cov$lambda_max/fallR.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
B.fallR.cov_l_ratio <- abs(log(fallR.cov$lambda_max/fallR.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
B.prevfallR_l_ratio <- abs(log(prevfallR.no.cov$lambda_max/prevfallR.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
B.prevfallR.cov_l_ratio <- abs(log(prevfallR.cov$lambda_max/prevfallR.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
B.prevwinterT_l_ratio <- abs(log(prevwinterT.no.cov$lambda_max/prevwinterT.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
B.prevwinterT.cov_l_ratio <- abs(log(prevwinterT.cov$lambda_max/prevwinterT.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
B.summerT_l_ratio <- abs(log(summerT.no.cov$lambda_max/summerT.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
B.summerT.cov_l_ratio <- abs(log(summerT.cov$lambda_max/summerT.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
B.dens_l_ratio <- abs(log(dens.no.cov$lambda_max/dens.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
B.dens.cov_l_ratio <- abs(log(dens.cov$lambda_max/dens.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
MT.fallR_l_ratio <- abs(log(fallR.no.cov$lambda_max/fallR.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
MT.fallR.cov_l_ratio <- abs(log(fallR.cov$lambda_max/fallR.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
MT.prevfallR_l_ratio <- abs(log(prevfallR.no.cov$lambda_max/prevfallR.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
MT.prevfallR.cov_l_ratio <- abs(log(prevfallR.cov$lambda_max/prevfallR.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
MT.prevwinterT_l_ratio <- abs(log(prevwinterT.no.cov$lambda_max/prevwinterT.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
MT.prevwinterT.cov_l_ratio <- abs(log(prevwinterT.cov$lambda_max/prevwinterT.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
MT.summerT_l_ratio <- abs(log(summerT.no.cov$lambda_max/summerT.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
MT.summerT.cov_l_ratio <- abs(log(summerT.cov$lambda_max/summerT.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
MT.dens_l_ratio <- abs(log(dens.no.cov$lambda_max/dens.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
MT.dens.cov_l_ratio <- abs(log(dens.cov$lambda_max/dens.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
P.fallR_l_ratio <- abs(log(fallR.no.cov$lambda_max/fallR.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
P.fallR.cov_l_ratio <- abs(log(fallR.cov$lambda_max/fallR.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
P.prevfallR_l_ratio <- abs(log(prevfallR.no.cov$lambda_max/prevfallR.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
P.prevfallR.cov_l_ratio <- abs(log(prevfallR.cov$lambda_max/prevfallR.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
P.prevwinterT_l_ratio <- abs(log(prevwinterT.no.cov$lambda_max/prevwinterT.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
P.prevwinterT.cov_l_ratio <- abs(log(prevwinterT.cov$lambda_max/prevwinterT.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
P.summerT_l_ratio <- abs(log(summerT.no.cov$lambda_max/summerT.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
P.summerT.cov_l_ratio <- abs(log(summerT.cov$lambda_max/summerT.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
P.dens_l_ratio <- abs(log(dens.no.cov$lambda_max/dens.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
P.dens.cov_l_ratio <- abs(log(dens.cov$lambda_max/dens.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
R.fallR_l_ratio <- abs(log(fallR.no.cov$lambda_max/fallR.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
R.fallR.cov_l_ratio <- abs(log(fallR.cov$lambda_max/fallR.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
R.prevfallR_l_ratio <- abs(log(prevfallR.no.cov$lambda_max/prevfallR.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
R.prevfallR.cov_l_ratio <- abs(log(prevfallR.cov$lambda_max/prevfallR.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
R.prevwinterT_l_ratio <- abs(log(prevwinterT.no.cov$lambda_max/prevwinterT.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
R.prevwinterT.cov_l_ratio <- abs(log(prevwinterT.cov$lambda_max/prevwinterT.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
R.summerT_l_ratio <- abs(log(summerT.no.cov$lambda_max/summerT.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
R.summerT.cov_l_ratio <- abs(log(summerT.cov$lambda_max/summerT.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
R.dens_l_ratio <- abs(log(dens.no.cov$lambda_max/dens.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
R.dens.cov_l_ratio <- abs(log(dens.cov$lambda_max/dens.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SCD.fallR_l_ratio <- abs(log(fallR.no.cov$lambda_max/fallR.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SCD.fallR.cov_l_ratio <- abs(log(fallR.cov$lambda_max/fallR.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SCD.prevfallR_l_ratio <- abs(log(prevfallR.no.cov$lambda_max/prevfallR.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SCD.prevfallR.cov_l_ratio <- abs(log(prevfallR.cov$lambda_max/prevfallR.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SCD.prevwinterT_l_ratio <- abs(log(prevwinterT.no.cov$lambda_max/prevwinterT.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SCD.prevwinterT.cov_l_ratio <- abs(log(prevwinterT.cov$lambda_max/prevwinterT.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SCD.summerT_l_ratio <- abs(log(summerT.no.cov$lambda_max/summerT.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SCD.summerT.cov_l_ratio <- abs(log(summerT.cov$lambda_max/summerT.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SCD.dens_l_ratio <- abs(log(dens.no.cov$lambda_max/dens.no.cov$lambda_min))
...
# Log ratios
# abs(log(lambda(mpm.max)/lambda(mpm.min)))
SCD.dens.cov_l_ratio <- abs(log(dens.cov$lambda_max/dens.cov$lambda_min))
...
df_fallR_l_ratio$l_ratio <- rowMeans(df_fallR_l_ratio)
...
df_fallR.cov_l_ratio <- data.frame(
  SC.fallR.cov_l_ratio,
  V.fallR.cov_l_ratio,
  SR.fallR.cov_l_ratio,
  B.fallR.cov_l_ratio,
  MT.fallR.cov_l_ratio,
  P.fallR.cov_l_ratio,
  R.fallR.cov_l_ratio,
  SCD.fallR.cov_l_ratio
)

df_fallR.cov_l_ratio$l_ratio <- rowMeans(df_fallR.cov_l_ratio)
...
df_prevfallR_l_ratio <- data.frame(
  SC.prevfallR_l_ratio,
  V.prevfallR_l_ratio,
  SR.prevfallR_l_ratio,
  B.prevfallR_l_ratio,
  MT.prevfallR_l_ratio,
  P.prevfallR_l_ratio,
  R.prevfallR_l_ratio,
  SCD.prevfallR_l_ratio
)

df_prevfallR_l_ratio$l_ratio <- rowMeans(df_prevfallR_l_ratio)
...
df_prevfallR.cov_l_ratio <- data.frame(
  SC.prevfallR.cov_l_ratio,
  V.prevfallR.cov_l_ratio,
  SR.prevfallR.cov_l_ratio,
  B.prevfallR.cov_l_ratio,
  MT.prevfallR.cov_l_ratio,
  P.prevfallR.cov_l_ratio,
  R.prevfallR.cov_l_ratio,
  SCD.prevfallR.cov_l_ratio
)

df_prevfallR.cov_l_ratio$l_ratio <- rowMeans(df_prevfallR.cov_l_ratio)
...
df_prevwinterT_l_ratio <- data.frame(
  SC.prevwinterT_l_ratio,
  V.prevwinterT_l_ratio,
  SR.prevwinterT_l_ratio,
  B.prevwinterT_l_ratio,
  MT.prevwinterT_l_ratio,
  P.prevwinterT_l_ratio,
  R.prevwinterT_l_ratio,
  SCD.prevwinterT_l_ratio
)

df_prevwinterT_l_ratio$l_ratio <- rowMeans(df_prevwinterT_l_ratio)
...
df_prevwinterT.cov_l_ratio <- data.frame(
  SC.prevwinterT.cov_l_ratio,
  V.prevwinterT.cov_l_ratio,
  SR.prevwinterT.cov_l_ratio,
  B.prevwinterT.cov_l_ratio,
  MT.prevwinterT.cov_l_ratio,
  P.prevwinterT.cov_l_ratio,
  R.prevwinterT.cov_l_ratio,
  SCD.prevwinterT.cov_l_ratio
)

df_prevwinterT.cov_l_ratio$l_ratio <- rowMeans(df_prevwinterT.cov_l_ratio)
...
df_summerT_l_ratio$l_ratio <- rowMeans(df_summerT_l_ratio)
...
df_summerT.cov_l_ratio <- data.frame(
  SC.summerT.cov_l_ratio,
  V.summerT.cov_l_ratio,
  SR.summerT.cov_l_ratio,
  B.summerT.cov_l_ratio,
  MT.summerT.cov_l_ratio,
  P.summerT.cov_l_ratio,
  R.summerT.cov_l_ratio,
  SCD.summerT.cov_l_ratio
)

df_summerT.cov_l_ratio$l_ratio <- rowMeans(df_summerT.cov_l_ratio)
...
df_dens_l_ratio$l_ratio <- rowMeans(df_dens_l_ratio)
...
df_dens.cov_l_ratio <- data.frame(
  SC.dens.cov_l_ratio,
  V.dens.cov_l_ratio,
  SR.dens.cov_l_ratio,
  B.dens.cov_l_ratio,
  ...
  P.dens.cov_l_ratio,
  R.dens.cov_l_ratio,
  SCD.dens.cov_l_ratio
)

df_dens.cov_l_ratio$l_ratio <- rowMeans(df_dens.cov_l_ratio)
...
Sens_DewyPines=data.frame(study.doi="Conquet et al. in prep",
                          ...
                          l_ratio=c(df_fallR_l_ratio$l_ratio, df_fallR.cov_l_ratio$l_ratio,
                                 df_prevfallR_l_ratio$l_ratio, df_prevfallR.cov_l_ratio$l_ratio,
                                 df_prevwinterT_l_ratio$l_ratio, df_prevwinterT.cov_l_ratio$l_ratio,
                                 df_summerT_l_ratio$l_ratio, df_summerT.cov_l_ratio$l_ratio,
                                 df_dens_l_ratio$l_ratio, df_dens.cov_l_ratio$l_ratio))
