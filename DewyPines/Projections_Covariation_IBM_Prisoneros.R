...
ibm_prisoneros_summerT_min_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_summerT_min_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_summerT_min_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_summerT_max_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_summerT_max_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_summerT_max_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_summerT_min_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_summerT_min_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_summerT_min_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_summerT_max_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_summerT_max_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_summerT_max_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_prevwinterT_min_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_prevwinterT_min_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_prevwinterT_min_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_prevwinterT_max_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_prevwinterT_max_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_prevwinterT_max_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_prevwinterT_min_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_prevwinterT_min_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_prevwinterT_min_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_prevwinterT_max_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_prevwinterT_max_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_prevwinterT_max_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_fallR_min_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_fallR_min_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_fallR_min_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_fallR_max_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_fallR_max_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_fallR_max_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_fallR_min_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_fallR_min_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_fallR_min_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_fallR_max_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_fallR_max_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_fallR_max_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_prevfallR_min_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_prevfallR_min_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_prevfallR_min_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_prevfallR_max_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_prevfallR_max_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_prevfallR_max_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_prevfallR_min_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_prevfallR_min_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_prevfallR_min_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_prevfallR_max_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_prevfallR_max_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_prevfallR_max_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_prevwinterR_min_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_prevwinterR_min_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_prevwinterR_min_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_prevwinterR_max_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_prevwinterR_max_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_prevwinterR_max_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_prevwinterR_min_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_prevwinterR_min_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_prevwinterR_min_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_prevwinterR_max_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_prevwinterR_max_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_prevwinterR_max_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_dens_min_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_dens_min_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_dens_min_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_dens_max_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_dens_max_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_dens_max_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_dens_min_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_dens_min_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_dens_min_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_dens_max_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_dens_max_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_dens_max_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_size_min_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_size_min_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_size_min_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_size_max_other_cov_mean <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_size_max_other_cov_mean, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_size_max_other_cov_mean)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_size_min_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_size_min_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_size_min_other_cov_obs)
...
# Results of each set of iterations are saved to a file
ibm_prisoneros_size_max_other_cov_obs <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_prisoneros_size_max_other_cov_obs, file = paste0("Output/IBM_", population, "_", focal_cov, "_", focal_min_max, "_other_", other_mean_obs , ".RData"))
sfStop()

rm(ibm_prisoneros_size_max_other_cov_obs)