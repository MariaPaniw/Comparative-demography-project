...
ibm_sierraretiny5_nrSurv_summerT_min <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierraretiny5_nrSurv_summerT_min, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_sierraretiny5_nrSurv_summerT_max <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierraretiny5_nrSurv_summerT_max, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_sierraretiny5_nrSurv_fallR_min <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierraretiny5_nrSurv_fallR_min, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_sierraretiny5_nrSurv_fallR_max <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierraretiny5_nrSurv_fallR_max, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_sierraretiny5_nrSurv_dens_min <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierraretiny5_nrSurv_dens_min, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_sierraretiny5_nrSurv_dens_max <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierraretiny5_nrSurv_dens_max, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_sierraretiny5_rSurv_summerT_min <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierraretiny5_rSurv_summerT_min, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_sierraretiny5_rSurv_summerT_max <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierraretiny5_rSurv_summerT_max, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_sierraretiny5_rSurv_fallR_min <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierraretiny5_rSurv_fallR_min, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_sierraretiny5_rSurv_fallR_max <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierraretiny5_rSurv_fallR_max, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_sierraretiny5_rSurv_dens_min <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierraretiny5_rSurv_dens_min, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_sierraretiny5_rSurv_dens_max <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierraretiny5_rSurv_dens_max, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_sierraretiny5_flowering_prevwinterT_min <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierraretiny5_flowering_prevwinterT_min, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_sierraretiny5_flowering_prevwinterT_max <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierraretiny5_flowering_prevwinterT_max, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_sierraretiny5_flowering_prevfallR_min <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierraretiny5_flowering_prevfallR_min, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_sierraretiny5_flowering_prevfallR_max <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierraretiny5_flowering_prevfallR_max, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_sierraretiny5_flowering_dens_min <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierraretiny5_flowering_dens_min, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()
...
# Every iteration is over "restart" number of steps at the end of each iteration,
# Results of each set of iterations are saved to a file
ibm_sierraretiny5_flowering_dens_max <- sfClusterApplyLB(1:ncpus, startIBM)

save(ibm_sierraretiny5_flowering_dens_max, file = paste0("Output/IBM_", population, "_", focal_vr, "_", focal_cov, "_", focal_min_max, ".RData"))
sfStop()