...
setwd("/Users/esinickin/Documents/Master Thesis/pert_analyses/Draco")
...
saveRDS(surv_mod, file = "results/rds/surv_flm.rds")
...
saveRDS(growth_mod, file = "results/rds/growth_flm.rds")
...
saveRDS(flowp_mod, file = "results/rds/flowp_flm.rds")
...
saveRDS(seedp_mod, file = "results/rds/seedp_flm.rds")
...
saveRDS(seedn_mod, file = "results/rds/seedn_flm.rds")
