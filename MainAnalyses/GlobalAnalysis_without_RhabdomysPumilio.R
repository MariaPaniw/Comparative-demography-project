...
# 1.3245052 /(1.3245052 +0.4629845+0.8653619)
# 0.4629845/(1.3245052 +0.4629845+0.8653619)
# 0.8653619/(1.3245052 +0.4629845+0.8653619)
...
mean.climate_df <- mean.climate_df %>%
  mutate(
...
plot.clim <- 
  ...
  geom_jitter(
    ...
    aes(x = mat, y = sens_mean, color = cov), 
    alpha = 0.7, 
    size = 5, 
    width = 0, 
    height = 0) +
  ...
  geom_errorbar(
    data = mean.climate_df,
    aes(x = mat, ymin = sens_lower, ymax = sens_upper, color = cov),
    inherit.aes = FALSE,
    width = 0.1,
    linewidth = 0.6,
    alpha = 0.8
  ...
  geom_text_repel(
    ...
    aes(x = mat, y = sens_mean, label = species, fontface = "italic"),
    size = 4,
