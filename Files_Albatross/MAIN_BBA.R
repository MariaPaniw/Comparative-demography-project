...
# set wd
setwd("/Users/esinickin/Desktop/Comparative-demography-project-main/Files_Albatross")
...
l_ratio.SST1=NULL
l_ratio.SST1.cov=NULL
l_ratio.SST2=NULL
l_ratio.SST2.cov=NULL
l_ratio.SST3=NULL
l_ratio.SST3.cov=NULL
l_ratio.SSTG=NULL
l_ratio.SSTG.cov=NULL
...
for(i in 1:100){
  ...
  #### Log ratios -----------
  #1. abs(log(lambda(mpm.max)/lambda(mpm.min)))
  l_ratio.SST1[i]=abs(log(max.lam/min.lam))
  ...
  #### Log ratios -----------
  #1. abs(log(lambda(mpm.max)/lambda(mpm.min)))
  l_ratio.SST1.cov[i]=abs(log(max.lam.cov/min.lam.cov))
  ...
  #### Log ratios -----------
  #1. abs(log(lambda(mpm.max)/lambda(mpm.min)))
  l_ratio.SST2[i]=abs(log(max.lam/min.lam))
  ...
  #### Log ratios -----------
  #1. abs(log(lambda(mpm.max)/lambda(mpm.min)))
  l_ratio.SST2.cov[i]=abs(log(max.lam/min.lam))
  ...
  #### Log ratios -----------
  #1. abs(log(lambda(mpm.max)/lambda(mpm.min)))
  l_ratio.SST3[i]=abs(log(max.lam/min.lam))
  ...
  #### Log ratios -----------
  #1. abs(log(lambda(mpm.max)/lambda(mpm.min)))
  l_ratio.SST3.cov[i]=abs(log(max.lam/min.lam))
  ...
  #### Log ratios -----------
  #1. abs(log(lambda(mpm.max)/lambda(mpm.min)))
  l_ratio.SSTG[i]=abs(log(max.lam/min.lam))
  ...
  #### Log ratios -----------
  #1. abs(log(lambda(mpm.max)/lambda(mpm.min)))
  l_ratio.SSTG.cov[i]=abs(log(max.lam/min.lam)) 
...
Results=data.frame(study.doi="110.1111/1365-2656.12827",
           ...
           l_ratio=c(l_ratio.SST1,l_ratio.SST1.cov,
                     l_ratio.SST2,l_ratio.SST2.cov,
                     l_ratio.SST3,l_ratio.SST3.cov,
                     l_ratio.SSTG,l_ratio.SSTG.cov))
