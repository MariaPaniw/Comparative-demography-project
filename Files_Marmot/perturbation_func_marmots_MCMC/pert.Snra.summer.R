summer_pertSnra_ipm <- function(year,env,env.pert,year.pert,i){
  ...
  S2nra <- diag(S2.fun(z,stage=2,year.sim.pert,Q.sim.pert,i),nrow=n,ncol=n) # Survival non-reproductive adults 
