...
````{r setup, include = F}
# set wd
knitr::opts_knit$set(root.dir="~/marmots")
...
sens_df=data.frame(study.doi="10.1111/ele.13459",
                  ...
                  n.vr=16, # number of vital rates
                  n.pam=38, # numver of parameters
                  vr_par=608, # product of the two above
                  dens=0, # is density dependence in it?
                 biotic_interactions=0 # what about other biotic interactions?
                 )

write.csv(sens_df,"SENS_MARMOTS_MCMC.csv",row.names = F)
...
write.csv(sensVR_df,"SENS_per_VR_MARMOTS_MCMC.csv",row.names = F)
