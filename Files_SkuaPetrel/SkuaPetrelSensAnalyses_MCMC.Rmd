...
sens.skua=data.frame(s.delta.SAM=na.omit(s.delta.SAM)[1:10],
                     ...
                     s.deltaDensP.cov=na.omit(s.delta.DensP.cov)[1:10])
...
sens.petrel=data.frame(p.delta.SAM=na.omit(p.delta.SAM)[1:10],
                       ...
                       p.deltaDensP.cov=na.omit(p.delta.DensP.cov)[1:10],
                       p.deltaSST.cov=na.omit(p.delta.SST.cov)[1:10],
                       p.deltaChla.cov=na.omit(p.delta.Chla.cov)[1:10])
...
s.df <- data.frame(study.doi="10.1002/ecm.1459",
                  ...
                  stage.age="all",
                  vital.rates="all",
                  sens=c(sens.skua$s.delta.SAM,sens.skua$s.deltaSAM.cov,sens.skua$s.delta.DensS,sens.skua$s.deltaDensS.cov,sens.skua$s.delta.DensP,sens.skua$s.deltaDensP.cov),
                  cov=rep(c(0,1),each=10),
                  gen.time=4, # generation time
                  n.vr=8, # number of vital rates
                  n.pam=28, # number of parameters
                  vr_par=224, # product of the two above
...
p.df <-  data.frame(study.doi="10.1002/ecm.1459",
                  ...
                  stage.age="all",
                  vital.rates="all",
                  sens=c(sens.petrel$p.delta.SAM,sens.petrel$p.deltaSAM.cov,sens.petrel$p.delta.DensP,sens.petrel$p.deltaDensP.cov,sens.petrel$p.delta.DensS,sens.petrel$p.deltaDensS.cov,sens.petrel$p.delta.SST,sens.petrel$p.deltaSST.cov,sens.petrel$p.delta.Chla,sens.petrel$p.deltaChla.cov),
                   cov=rep(c(0,1),each=10),
                  gen.time=4,
                  n.vr=8,
                  n.pam=46,
