...
p.df <-  data.frame(study.doi="10.1002/ecm.1459",
                  ...
                  stage.age="all",
                  vital.rates="all",
                  sens=c(p.delta.SAM,p.deltaSAM.cov,p.delta.DensP,p.deltaDensP.cov,p.delta.DensS,p.deltaDensS.cov,p.delta.SST,p.deltaSST.cov,p.delta.Chla,p.deltaChla.cov),
                   cov=rep(c(0,1),each=10),
                  mat=4,
                  n.vr=8, # number of vital rates with covariates
